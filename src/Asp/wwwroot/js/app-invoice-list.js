        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/Invoice/Preview" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="نمایش فاکتور"><i class="ti ti-eye mx-2 ti-sm"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="/Invoice/Edit" class="dropdown-item">ویرایش</a>' +
