...
$(document).ready(function () {
  ...
  $('#transactionsTable').DataTable({
    ...
    buttons: [
      {
        extend: 'collection',
        className: 'btn btn-label-secondary dropdown-toggle ms-2 me-0 me-md-3 mx-sm-3 waves-effect waves-light',
        text: '<i class="ti ti-download me-1"></i>گرفتن خروجی',
        buttons: [
          {
            extend: 'print',
            title: 'اطلاعات تراکنش',
            text: '<i class="ti ti-printer me-2" ></i>چاپ کردن',
          ...
          },
          {
            extend: 'copy',
            title: 'تراکنش ها',
            text: '<i class="ti ti-copy me-2" ></i>کپی کردن',
            className: 'dropdown-item',
            exportOptions: {
              columns: [1, 2, 3, 4, 5, 6]
            }
      ...
      },
      {
        ...
        text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-md-inline-block">تراکنش جدید</span>',
